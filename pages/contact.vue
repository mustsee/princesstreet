<template>
  <div class="columns-2 contact">
    <div class="contact-info">
      <h1>{{ company.name }}</h1>
      <h2>Information & Reservation Board</h2>
      <ul class="contact-info--social-media">
        <li>
          <a href="#" rel="noopener" title="TripAdvisor" target="_blank"
        ...
        <li>
          <a href="#" rel="noopener" title="Instagram" target="_blank"
        ...
        <li>
          <a href="#" rel="noopener" title="Whatsapp" target="_blank"
            ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
              <path
      ...
      <address>
        <ul>
          <li class="alamat material-icon">
            {{ company.address }}<br v-if="company.address2" />{{
              company.address2
            }}
          </li>
          <li class="telp material-icon">
            <a
              :href="`tel:${
                company.phone ? company.phone.split('').join('') : ''
              }`"
              title="call for information"
              >{{ company.phone }}</a
            >
          </li>
          <li class="email material-icon">
            <a href="#" title="send mail for information">{{
              company.email
            }}</a>
          </li>
        </ul>
    ...
    <div class="contact-form">
      <form id="form" @submit.prevent="onSubmit">
        ...
        <input
          ...
          placeholder="Phone*"
        />
        <select name="type-hear" id="type-hear">
        ...
        ></textarea>
        <label>* Please fill in all fields marked as compulsory</label
        ><br /><br />
